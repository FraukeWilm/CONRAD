...
public class Raw_Data_Opener_Standalone extends JFrame implements ActionListener, PlugIn {
	/**
	 * 
	 */
	...
	private class OpenerTransferHandler extends TransferHandler {
		...
		Raw_Data_Opener_Standalone field;

		public OpenerTransferHandler(Raw_Data_Opener_Standalone field){
			super();
			this.field = field;
		}
	...
	public Raw_Data_Opener_Standalone(){
	...
	public void run(String arg) {
		...
		Raw_Data_Opener_Standalone opener = new Raw_Data_Opener_Standalone();
