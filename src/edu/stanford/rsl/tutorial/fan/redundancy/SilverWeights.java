...
public class SilverWeights extends Grid2D {
	...
	public SilverWeights(final double focalLength, final double maxT,
		...
		for (int t = 0; t < maxTIndex; ++t) {
			...
			for (int b = 0; b < maxLambdaIndex; ++b) {
				...
				// Second case: Handles weights for redundancies at the beginning of the scan
...
/*		// Low pass filtering of first and last 15 columns to avoid step functions
	...
	public static void main (String [] args){
		...
		Grid3D g = new Grid3D((int)maxT, 181, 0);
		...
		for (int i = 0; i < 360; ++i)
		{
			...
			SilverWeights p = new SilverWeights(focalLength, maxT, deltaT, maxBeta, deltaBeta);
