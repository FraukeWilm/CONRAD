...
public class Viva_Reader extends ImagePlus implements PlugIn {

	public void run(String arg) {
		boolean display = false;
		File test = new File(arg);
		display = !test.exists();
		OpenDialog od = new OpenDialog("Open viva file...", arg);
		if(od!=null){
		...
		try {
			FileProjectionSource fileSource = new SEQProjectionSource();
